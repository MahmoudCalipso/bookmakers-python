...
if len(sys.argv) > 3:
    ...
    event_feed_url = 'http://www.smart-feeds.com/getfeeds.aspx?Param=betoffer/live/event/{id}' if live else 'http://www.smart-feeds.com/getfeeds.aspx?Param=betoffer/event/{id}'
